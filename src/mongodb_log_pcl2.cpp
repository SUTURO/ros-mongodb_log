...
/***************************************************************************
 *  mongodb_log_pcl.cpp - MongoDB Logger for point cloud 2 topics
 *
 *  Created: Mon Dec 13 15:05:37 2010
 *  Copyright  2015  Tom Gehrke [tom.gehrke@uni-bremen.de]
 ****************************************************************************/
...
void msg_callback(const sensor_msgs::PointCloud2::ConstPtr& msg)
{
  ...
  const sensor_msgs::PointCloud2& msg_in = *msg;
...
main(int argc, char **argv)
{
  ...
  ros::Subscriber sub = n.subscribe<sensor_msgs::PointCloud2>(topic, 1000, msg_callback);
